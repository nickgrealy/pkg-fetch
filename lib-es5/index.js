      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            nodeRange = opts.nodeRange, platform = opts.platform, arch = opts.arch, forceFetch = opts.forceFetch, forceBuild = opts.forceBuild, fullyStatic = opts.fullyStatic, dryRun = opts.dryRun;
          ...
          case 44:
            if (fullyStatic) {
              _log.log.info('Using "fully static" linking');
            }
          ...
          case 55:
            _context.next = 57;
            return (0, _build.default)(nodeVersion, arch, built, opts);
